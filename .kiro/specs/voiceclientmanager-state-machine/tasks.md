...
- [ ] 1. Create VoiceSessionState sealed class
  - [ ] 1.1 Create `state/VoiceSessionState.kt`
...
- [ ] 6. Checkpoint - Verify ConversationMonitor works
  - Ensure ConversationMonitor compiles and timer logic is correct

## Phase 3: Implement State Machine Reducer

- [ ] 7. Create VoiceSessionStateMachine
  - [ ] 7.1 Create `state/VoiceSessionStateMachine.kt`
...
- [ ] 8. Implement state entry/exit side effects
  - [ ] 8.1 Add side effects for state transitions
  ...
  - [ ] 8.2 Write property tests for side effects
...
- [ ] 9. Checkpoint - Verify state machine logic
  - Ensure all tests pass, ask the user if questions arise.

## Phase 4: Create VoiceUiState and Mapper

- [ ] 10. Create VoiceUiState
  - [ ] 10.1 Create `state/VoiceUiState.kt`
...
- [ ] 11. Create VoiceUiStateMapper
  - [ ] 11.1 Create `state/VoiceUiStateMapper.kt`
...
- [ ] 14. Implement event processing
  - [ ] 14.1 Create processEvent() method
...
- [ ] 15. Implement side effect executor
  - [ ] 15.1 Create executeSideEffects() method
...
- [ ] 16. Wire component events to state machine
  - [ ] 16.1 Update AudioEngine listener
    - Wrap onAudioRecorded in VoiceEvent.AudioInput
    - Call processEvent()
    - _Requirements: 5.1_
  - [ ] 16.2 Update WebSocketClient listener
...
- [ ] 18. Sync legacy properties from VoiceUiState
  ...
  - [ ] 18.2 Write property tests for legacy getters
    - **Property 8: Legacy property getters match VoiceUiState fields**
    - **Validates: Requirements 4.6, 4.7**

- [ ] 19. Remove scattered state assignments
  - [ ] 19.1 Remove direct assignments to legacy fields throughout the code
...
- [ ] 20. Remove timer Jobs from VoiceClientManager
  - [ ] 20.1 Remove timer-related code
...
- [ ] 21. Checkpoint - Verify backward compatibility
  - Ensure all tests pass, ask the user if questions arise.

## Phase 7: Refactor Public Methods

- [ ] 22. Refactor start() method
  - [ ] 22.1 Update start() to use events
...
- [ ] 23. Refactor stop() method
  - [ ] 23.1 Update stop() to use events
...
- [ ] 29. Verify backward compatibility
  - [ ] 29.1 Test all existing functionality
